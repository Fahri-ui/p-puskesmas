                ...
                <div class="col-lg-6">
                    <div class="image-section" data-aos="fade-left" data-aos-delay="200">
                        <div class="main-image">
                            <img src="{{ asset('MediTrust/assets/img/health/consultation-3.webp') }}" alt="Healthcare consultation" class="img-fluid">
                        </div>
                        <div class="image-grid">
                            <div class="grid-item">
                                <img src="{{ asset('MediTrust/assets/img/health/facilities-2.webp') }}" alt="Medical facility" class="img-fluid">
                            </div>
                            <div class="grid-item">
                                <img src="{{ asset('MediTrust/assets/img/health/staff-5.webp') }}" alt="Medical staff" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="certifications-grid">
                            <div class="certification-item">
                                <img src="{{ asset('MediTrust/assets/img/clients/clients-1.webp') }}" alt="JCI Accreditation" class="img-fluid">
                            </div>
                            <div class="certification-item">
                                <img src="{{ asset('MediTrust/assets/img/clients/clients-2.webp') }}" alt="NABH Certification" class="img-fluid">
                            </div>
                            <div class="certification-item">
                                <img src="{{ asset('MediTrust/assets/img/clients/clients-3.webp') }}" alt="ISO 9001" class="img-fluid">
                            </div>
                            <div class="certification-item">
                                <img src="{{ asset('MediTrust/assets/img/clients/clients-4.webp') }}" alt="CAP Accreditation" class="img-fluid">
                            </div>
                            <div class="certification-item">
                                <img src="{{ asset('MediTrust/assets/img/clients/clients-5.webp') }}" alt="Medical Board" class="img-fluid">
                            </div>
                            <div class="certification-item">
                                <img src="{{ asset('MediTrust/assets/img/clients/clients-6.webp') }}" alt="Healthcare Association" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
